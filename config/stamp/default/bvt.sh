...
LMS_URL=republic-learning.$BASE_URL
CMS_URL=republic-studio.$BASE_URL
PREVIEW_URL=republicpreview.$BASE_URL
...
# config/versions.yml
CONFIGURATION_REPO=https://github.com/repubpoly/edx-configuration.git
CONFIGURATION_VERSION=oxa/master.fic
PLATFORM_REPO=https://github.com/repubpoly/edx-platform.git
